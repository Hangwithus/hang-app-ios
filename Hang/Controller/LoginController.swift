...
//  Hang
//
//  Created by Nolan Canady on 5/7/18.
...
class LoginController: UIViewController, UITextFieldDelegate {
    ...
    @objc func handleRegister() {
        ...
        Auth.auth().createUser(withEmail: email, password: password, completion: { (user: User?, error) in
            ...
            let values = ["name": name, "email": email, "available":"false", "status":"status", "friendCode":friendCode, "numFriends":"0", "emoji":"❤️", "time":"0m", "lastAvailable":"5-9-18_10:05", "latitude":"0", "longitude":"0"]
